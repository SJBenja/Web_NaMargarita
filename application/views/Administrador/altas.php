<h1>Aqui van todos los productos</h1>
<section class="alta">
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">
                    <form class="w-50 mx-auto" method="POST" action="<?php echo base_url('alta');?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nombre" class="form-control" type="text" name="nombre" placeholder="Ingrese el nombre del producto" autofocus="autofocus"  value="<?php echo set_value('nombre') ;?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="descripcion" class="form-control" type="text" name="descripcion" placeholder="Ingrese un breve descripción" autofocus="autofocus"  value="<?php echo set_value('descripcion') ;?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="precio" class="form-control" type="text" name="precio" placeholder="Ingrese el precio del producto" autofocus="autofocus"  value="<?php echo set_value('precio') ;?>">
                        </div>
                        ...
                        <div class="form-group py-2">
                            ...
                            <a href="<?php echo base_url('listaProductos')?>" class='btn btn-danger'>Cancelar</a>
                        </div>
                    </form>
                </p>
            </div>
