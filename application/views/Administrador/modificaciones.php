<h1>Aqui van las modificaciones</h1>
                        ...
                        <div class="col-8">
                            <form class="w-75 mx-auto" method="POST" action="<?php echo base_url('modificar').$productos->id_producto;?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="categoria" class="form-control" type="text" name="categoria" value="<?php echo $productos->nombreCate?>" autofocus="autofocus"  value="<?php echo set_value('categoria') ;?>">
                                ...
                                <!--Imagen-->
                                <div class="form-group">
                                    <label for="imagen" class="text-black font-weight-bold">Cambiar imagen (No mayor a 2 Mb)</label>
