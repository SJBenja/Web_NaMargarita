<h1>Aca se cargan todos los productos al carrito</h1>
...
<div class="text ml-2" > 
	<?php  $cart_check = $this->cart->contents();
		...
		if (empty($cart_check)){?>
            <br>
			<h3 class="text-center">Para agregar productos al carrito, click en
                <a href="<?php echo base_url('productosU')?>" class="btn btn-outline-danger btn-lg" type="button">Comprar</a>
            </h3> 
		<?php }
    ?>    
</div>
...
<?php if($this->cart->contents()){?>
                ...
                <?php foreach ($this->cart->contents() as $items): ?>
                    <?php echo form_hidden($i.'[rowid]', $items['rowid']); ?>
                        <tr>
                            ...
                            <td><?php echo form_input(array('name' => $i.'[qty]', 'value' => $items['qty'], 'maxlength' => '3', 'size' => '5', 'id' => 'cantidad', 'pattern' => '\d+')); ?></td>
    ...
    <p><?php echo form_submit('actualizarCarrito', 'Actualizar Carrito'); ?></p>
